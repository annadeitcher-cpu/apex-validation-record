...
def build_panel_a(cur, today):
    ...
    role_labels = {"ae": "AE", "sc": "SC", "customer": "Customer"}
    ...
    # On-time completion rate per AE / per SC
...
def render_on_time_card(pa):
    ...
    <div class="card">
      <h3>On-time completion rate — SC</h3>
      <table><thead><tr><th>Owner</th><th class="num">Rate</th><th class="num">Sample</th></tr></thead>
      ...
      <div class="panel-b-wrap">
        ...
        <div class="card-grid">
          ...
          <div class="card card-wide">
            ...
            {pb['behavior_chart']}
            <p class="footnote">Targets: bottom quartile to 1.5, middle to 1.8. Baseline only — five reps isn't a population you can split into quartiles, so no "observed quartile" bar is shown next to it. SC summary-doc completion rate baseline: ~{pb['sc_summary_pct']:g}%.</p>
